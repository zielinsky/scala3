// Test for issue #24007: Regression in zio/zio-schema for typer/implicit resolution
// This test ensures that TypeParamRef doesn't cause divergence in implicit search
// due to over-counting type size when bounds are included
